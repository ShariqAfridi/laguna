...
<body>
    ...
    <section class="hero-banner">
        <div class="content">
            <h2 class="subtitle">THE COLLECTION</h2>
            <h1 class="title">Ready to be lit.</h1>
            <p class="description">
                Our signature compositions, hand-poured in small batches and ready to ship.
            </p>
        </div>
    </section>
