...
?>
<!-- FontAwesome for ADA suite icons -->
...
<div id="adaAccessibilityWrapper" role="region" aria-label="Accessibility Tools">
    ...
    <!-- 4. Floating Trigger Button (Hidden - Replaced by Upper Right Header Bar Button) -->
    <button type="button" id="adaTriggerBtn" style="display:none;" aria-label="Open Accessibility Menu (Alt+A)" aria-haspopup="dialog" aria-expanded="false" title="Accessibility Tools (Alt+A)">
